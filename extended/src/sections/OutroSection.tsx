...
export function OutroSection() {
  return (
    ...
    >
      ...
      <Caption>
        Celý zdrojový kód vrátane FFT implementácie a testov je v repozitári — priečinok{' '}
        <span className="font-mono">extended/</span>. Odporúčaný experiment na doma: over si
        Parsevalovu rovnosť na vlastných dátach.
      </Caption>
    </Section>
  )
}
