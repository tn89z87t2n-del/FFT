# FFT Simple (v1) — interaktívne vysvetlenie Fast Fourier Transform

Pôvodná, jednoduchšia verzia interaktívnej vzdelávacej stránky o **Fast
Fourier Transform** — od základnej intuície až po algoritmus **Cooley-Tukey
radix-2**. Novšia a rozšírená hlavná verzia (FFT LAB v2) žije v koreni
repozitára.

> 🔴 **Živá ukážka tejto verzie:** https://tn89z87t2n-del.github.io/FFT/simple/
>
> 🧪 **Hlavná verzia — FFT LAB v2:** https://tn89z87t2n-del.github.io/FFT/
> (zdroják v koreni repozitára)
